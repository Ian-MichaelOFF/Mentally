...
const Anagrama: React.FC = () => {
  ...
  const wordSets = {
  facil: ["gato","perro","sol","mar","pan"],
  medio: ["avion","luna","agua","flor","puerta","camino","cuerda","planta","papel","trampa"],
  dificil: ["mandarina","sandia","toronja","sillon","ciruela","abrazo","fresa","frambuesa",
"esqui","basquetbol","lancha","rueda"],
  };
