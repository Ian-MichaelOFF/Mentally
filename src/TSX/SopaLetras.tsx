...
const SopaDeLetras: React.FC = () => {
  ...
  const words = {
    easy: ["gato", "perro", "sol"],
    medium: ["avion", "luna", "agua", "flor", "puerta", "camino"],
    hard: ["luz", "redes", "mandarina", "sandia", "toronja", "sillon", "ciruela", "abrazo", "fresa"],
  };
  ...
  const setDifficulty = (level: string) => {
    ...
    else if (level === "medium") initialTime = 120;
    else if (level === "hard") initialTime = 90;
  ...
  useEffect(() => {
    if (gameStarted) {
      ...
      else if (currentLevel === "medium") setTimeLeft(120);
      else if (currentLevel === "hard") setTimeLeft(90);
  ...
  const startTimer = () => {
    ...
    else if (currentLevel === "medium") initialTime = 120;
    else if (currentLevel === "hard") initialTime = 90;
